...
def evaluate_without_rate_limit(
    ...
    print("--- :zap: Running evaluation without rate limiting... ---")
    ...
    print("--- :white_check_mark: Evaluation complete! ---")
...
def save_results(results_df: pd.DataFrame, filename_prefix: str) -> None:
    ...
    print(f"--- :floppy_disk: Detailed results saved to {detailed_path} ---")
    ...
    if param_cols:
        ...
        print(f"--- :floppy_disk: Summary of average scores saved to {summary_path} ---")
...
def evaluate_with_rate_limit(
    ...
    print("--- :turtle: Running evaluation with rate limiting... ---")
